...
public class ConnectionManager {
	...
	private EObject getStageEObject() {
		final EClass eClass = MongoPadPPPackage.eINSTANCE.getStage();
	...
	public void createComposite(Composite parent) {
		final EObject stageObject = getStageEObject();
		try {
			...
			final ViewModelContext vmc = ViewModelContextFactory.INSTANCE.createViewModelContext(
				ViewProviderHelper.getView(stageObject, null), stageObject, new DefaultReferenceService());
